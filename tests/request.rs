...
fn balanced_echos_from_two_remotes() {
    ...
    node_three.register("echo", Box::new(|_| {
    ...
    assert_eq!("40", String::from_utf8_lossy(&node_one.request("echo", b"").unwrap()));
    assert_eq!("100", String::from_utf8_lossy(&node_one.request("echo", b"").unwrap()));
